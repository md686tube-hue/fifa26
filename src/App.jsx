...
const SQUADS={
  ...
  Mexico:{coach:"Javier Aguirre",players:[
    ...
    {num:13,pos:"GK",name:"Guillermo Ochoa",club:"AEL Limassol"},
    {num:22,pos:"GK",name:"Carlos Acevedo",club:"Santos Laguna"},
    ...
    {num:12,pos:"DEF",name:"Israel Reyes",club:"América"},
  ...
  "South Korea":{coach:"Hong Myung-bo",players:[
    ...
    {num:15,pos:"DEF",name:"Jens Castrop",club:"Borussia M'gladbach"},
  ...
  "Czech Republic":{coach:"Miroslav Koubek",players:[
    ...
    {num:12,pos:"GK",name:"Antonin Kinský",club:"Tottenham"},
    ...
    {num:16,pos:"DEF",name:"David Doudera",club:"Slavia Prague"},
    ...
    {num:13,pos:"FWD",name:"Jan Kuchta",club:"Sparta Prague"},
  ...
  "South Africa":{coach:"Hugo Broos",players:[
    ...
    {num:11,pos:"MID",name:"Lyle Foster",club:"Burnley"},
    {num:14,pos:"MID",name:"Ethan Nkosi",club:"Mamelodi Sundowns"},
    ...
    {num:19,pos:"FWD",name:"Lyle Foster",club:"Burnley"},
    {num:20,pos:"FWD",name:"Iqraam Rayners",club:"Mamelodi Sundowns"},
    {num:21,pos:"FWD",name:"Relebohile Mofokeng",club:"Orlando Pirates"},
  ]},
  // ── GROUP B ──────────────────────────────────────────────────
  "Bosnia & Herzegovina":{coach:"Sergej Barbarez",players:[
    {num:1,pos:"GK",name:"Nikola Vasilj",club:"FC St. Pauli"},
    {num:12,pos:"GK",name:"Martin Zlomislic",club:"HNK Rijeka"},
    {num:23,pos:"GK",name:"Osman Hadzikic",club:"Slaven Belupo"},
    {num:2,pos:"DEF",name:"Amar Dedic",club:"Benfica"},
    {num:3,pos:"DEF",name:"Sead Kolasinac",club:"Atalanta"},
    {num:4,pos:"DEF",name:"Nikola Katic",club:"Schalke 04"},
    {num:5,pos:"DEF",name:"Tarik Muharemovic",club:"Sassuolo"},
    {num:6,pos:"DEF",name:"Dennis Hadzikadunic",club:"Sampdoria"},
    {num:14,pos:"DEF",name:"Nihad Mujakic",club:"Gaziantep"},
    {num:15,pos:"DEF",name:"Stjepan Radeljic",club:"HNK Rijeka"},
    {num:16,pos:"DEF",name:"Nidal Celik",club:"Lens"},
    {num:8,pos:"MID",name:"Amir Hadžiahmetović",club:"Hull City"},
    {num:10,pos:"MID",name:"Benjamin Tahirovic",club:"Brondby"},
    {num:17,pos:"MID",name:"Dzenis Burnic",club:"Karlsruher SC"},
    {num:18,pos:"MID",name:"Ivan Sunjic",club:"Pafos FC"},
    {num:19,pos:"MID",name:"Ivan Basic",club:"FC Astana"},
    {num:20,pos:"MID",name:"Armin Gigovic",club:"BSC Young Boys"},
    {num:9,pos:"FWD",name:"Edin Džeko",club:"Schalke 04"},
    {num:7,pos:"FWD",name:"Ermedin Demirovic",club:"Stuttgart"},
    {num:11,pos:"FWD",name:"Haris Tabakovic",club:"Borussia M'gladbach"},
    {num:13,pos:"FWD",name:"Esmir Bajraktarevic",club:"PSV Eindhoven"},
    {num:21,pos:"FWD",name:"Samed Bazdar",club:"Jagiellonia"},
    {num:22,pos:"FWD",name:"Kerim Alajbegovic",club:"RB Salzburg"},
    {num:24,pos:"FWD",name:"Jovo Lukic",club:"Universitatea Cluj"},
  ]},
  Canada:{coach:"Jesse Marsch",players:[
    ...
    {num:22,pos:"FWD",name:"Raheem Edwards",club:"Los Angeles FC"},
  ]},
  Qatar:{coach:"Julen Lopetegui",players:[
    ...
    {num:15,pos:"DEF",name:"Ayoub Al-Alawi",club:"Al Gharafa"},
    {num:8,pos:"MID",name:"Karim Boudiaf",club:"Al Duhail"},
    {num:10,pos:"MID",name:"Abdulelah Hattab",club:"Al Gharafa"},
    {num:14,pos:"MID",name:"Assim Madibo",club:"Al Wakrah"},
    ...
    {num:19,pos:"FWD",name:"Hassan Al-Haydos",club:"Al Sadd"},
    {num:20,pos:"FWD",name:"Edmilson Junior",club:"Al Duhail"},
    {num:21,pos:"FWD",name:"Tahsin Mohammed",club:"Al Duhail"},
  ]},
  Switzerland:{coach:"Murat Yakin",players:[
    ...
    {num:22,pos:"FWD",name:"Dan Ndoye",club:"Nottingham Forest"},
    {num:23,pos:"FWD",name:"Noah Okafor",club:"Leeds United"},
    {num:24,pos:"FWD",name:"Cedric Itten",club:"Fortuna Düsseldorf"},
  ]},
  // ── GROUP C ──────────────────────────────────────────────────
  ...
  Haiti:{coach:"Sébastien Migné",players:[
    ...
    {num:16,pos:"MID",name:"Leverton Pierre",club:"Vizela"},
    {num:17,pos:"MID",name:"Carl Sainte",club:"El Paso Locomotive"},
    ...
    {num:19,pos:"FWD",name:"Derrick Etienne",club:"Toronto FC"},
    {num:20,pos:"FWD",name:"Josue Casimir",club:"Auxerre"},
    {num:21,pos:"FWD",name:"Ruben Providence",club:"Almere"},
    {num:22,pos:"FWD",name:"Lenny Joseph",club:"Ferencváros"},
  ]},
  Morocco:{coach:"Mohamed Ouahbi",players:[
    ...
    {num:6,pos:"DEF",name:"Romain Saiss",club:"Beşiktaş"},
  ...
  Scotland:{coach:"Steve Clarke",players:[
    ...
    {num:17,pos:"DEF",name:"Dominic Hyam",club:"Wrexham"},
    ...
    {num:22,pos:"FWD",name:"Lyndon Dykes",club:"Charlton"},
    {num:24,pos:"FWD",name:"George Hirst",club:"Ipswich"},
    {num:25,pos:"FWD",name:"Ross Stewart",club:"Southampton"},
  ]},
  // ── GROUP D ──────────────────────────────────────────────────
  ...
  USA:{coach:"Mauricio Pochettino",players:[
    ...
    {num:16,pos:"DEF",name:"Alex Freeman",club:"Nottingham Forest"},
    ...
    {num:20,pos:"MID",name:"Sebastian Berhalter",club:"Chicago Fire"},
    {num:21,pos:"MID",name:"Malik Tillman",club:"PSV"},
    ...
    {num:25,pos:"FWD",name:"Ollie Watkins",club:"Aston Villa"},
    {num:26,pos:"FWD",name:"Alex Zendejas",club:"Club América"},
  ]},
  ...
  Germany:{coach:"Julian Nagelsmann",players:[
    ...
    {num:16,pos:"FWD",name:"Nadiem Amiri",club:"Galatasaray"},
    {num:21,pos:"FWD",name:"Denis Undav",club:"Stuttgart"},
    {num:24,pos:"FWD",name:"Jamie Leweling",club:"Stuttgart"},
    {num:25,pos:"FWD",name:"Nick Woltemeade",club:"Stuttgart"},
  ]},
  ...
  Ecuador:{coach:"Sebastián Beccacece",players:[
    ...
    {num:19,pos:"MID",name:"Jose Cifuentes",club:"LA FC"},
  ...
  Curaçao:{coach:"Dick Advocaat",players:[
    ...
    {num:20,pos:"FWD",name:"Jurgen Locadia",club:"Miami FC"},
    {num:21,pos:"FWD",name:"Kenji Gorre",club:"Maccabi Haifa"},
    {num:22,pos:"FWD",name:"Gervane Kastaneer",club:"Pafos"},
  ]},
  // ── GROUP F ──────────────────────────────────────────────────
  ...
  Japan:{coach:"Hajime Moriyasu",players:[
    ...
    {num:15,pos:"FWD",name:"Koki Ogawa",club:"NEC Nijmegen"},
    {num:22,pos:"FWD",name:"Yuito Suzuki",club:"Freiburg"},
    {num:24,pos:"FWD",name:"Kento Shiogai",club:"Wolfsburg"},
  ]},
  Sweden:{coach:"Graham Potter",players:[
    ...
    {num:16,pos:"MID",name:"Jesper Karlström",club:"Udinese"},
    {num:17,pos:"MID",name:"Yasin Ayari",club:"Brighton"},
    {num:18,pos:"MID",name:"Taha Ali",club:"Malmö"},
    {num:19,pos:"MID",name:"Eric Smith",club:"Stuttgart"},
    ...
    {num:20,pos:"FWD",name:"Ken Sema",club:"Pafos"},
    {num:21,pos:"FWD",name:"Alexander Bernhardsson",club:"Holstein Kiel"},
    {num:22,pos:"FWD",name:"Benjamin Nygren",club:"Celtic"},
  ]},
  Tunisia:{coach:"Sabri Lamouchi",players:[
    ...
    {num:19,pos:"MID",name:"Ismael Gharbi",club:"Augsburg"},
  ...
  Egypt:{coach:"Hossam Hassan",players:[
    ...
    {num:15,pos:"FWD",name:"Mohanad Lasheen",club:"Pyramids FC"},
    {num:20,pos:"FWD",name:"Hamza Abdelkarim",club:"Barcelona"},
    {num:21,pos:"FWD",name:"Aqtay Abdallah",club:"Enppi"},
  ]},
  Iran:{coach:"Amir Ghalenoei",players:[
    ...
    {num:15,pos:"FWD",name:"Karim Ansarifard",club:"Sepahan"},
    {num:16,pos:"FWD",name:"Amirhossein Hosseinzadeh",club:"Tractor"},
  ]},
  "New Zealand":{coach:"Darren Bazeley",players:[
    ...
    {num:15,pos:"DEF",name:"Callan Elliot",club:"Auckland FC"},
    ...
    {num:21,pos:"FWD",name:"Ben Waine",club:"Port Vale"},
    {num:22,pos:"FWD",name:"Jesse Randall",club:"Auckland FC"},
  ]},
  // ── GROUP H ──────────────────────────────────────────────────
  Spain:{coach:"Luis de la Fuente",players:[
    ...
    {num:15,pos:"DEF",name:"Marc Cubill",club:"Barcelona"},
    ...
    {num:25,pos:"FWD",name:"Borja Iglesias",club:"Bayer Leverkusen"},
  ]},
  ...
  "Saudi Arabia":{coach:"Georgios Donis",players:[
    ...
    {num:14,pos:"DEF",name:"Mohamed Kanno",club:"Al-Hilal"},
    ...
    {num:20,pos:"MID",name:"Mohamed Al-Burayk",club:"Al-Hilal"},
    ...
    {num:16,pos:"FWD",name:"Nawaf Al-Bostaji",club:"Al-Qadsiah"},
  ]},
  "Cabo Verde":{coach:"Bubista",players:[
    {num:1,pos:"GK",name:"Josimar Dias",club:"Chaves"},
    ...
    {num:16,pos:"MID",name:"Deroy Duarte",club:"Ludogorets"},
    {num:17,pos:"MID",name:"Telmo Arcanjo",club:"Pacos Ferreira"},
    {num:18,pos:"MID",name:"Laros Duarte",club:"Vitesse"},
    {num:19,pos:"MID",name:"Yannick Semedo",club:"Guimarães"},
    {num:7,pos:"FWD",name:"Garry Rodrigues",club:"Al Gharafa"},
    {num:9,pos:"FWD",name:"Jovane Cabral",club:"Lazio"},
    {num:11,pos:"FWD",name:"Ryan Mendes",club:"Al Arabi"},
    {num:20,pos:"FWD",name:"Willy Semedo",club:"Famalicao"},
    {num:21,pos:"FWD",name:"Gilson Benchimol",club:"Académico de Viseu"},
  ]},
  // ── GROUP I ──────────────────────────────────────────────────
  France:{coach:"Didier Deschamps",players:[
    ...
    {num:10,pos:"MID",name:"Kylian Mbappé",club:"Real Madrid"},
    {num:18,pos:"MID",name:"Adrien Rabiot",club:"AC Milan"},
    {num:19,pos:"MID",name:"Manu Koné",club:"Roma"},
    {num:20,pos:"MID",name:"N'Golo Kanté",club:"Fenerbahçe"},
    {num:21,pos:"MID",name:"Warren Zaïre-Emery",club:"PSG"},
    {num:7,pos:"FWD",name:"Ousmane Dembélé",club:"PSG"},
    {num:9,pos:"FWD",name:"Rayan Cherki",club:"Man City"},
    ...
    {num:25,pos:"FWD",name:"Jean-Philippe Mateta",club:"Crystal Palace"},
  ...
  Iraq:{coach:"Graham Arnold",players:[
    ...
    {num:13,pos:"DEF",name:"Hussein Ali",club:"Al-Shorta"},
    ...
    {num:19,pos:"MID",name:"Safaa Hadi",club:"Al-Shorta"},
    ...
    {num:14,pos:"FWD",name:"Suad Natiq",club:"Al-Najaf"},
    {num:15,pos:"FWD",name:"Aziz Khyon",club:"Al-Quwa Al-Jawiya"},
  ]},
  Norway:{coach:"Ståle Solbakken",players:[
    ...
    {num:14,pos:"DEF",name:"Torbjørn Heggem",club:"Rosenborg"},
  ...
  Senegal:{coach:"Pape Thiaw",players:[
    ...
    {num:16,pos:"GK",name:"Mory Diaw",club:"Clermont Foot"},
    {num:23,pos:"GK",name:"Yehvann Diouf",club:"Stade Reims"},
    {num:2,pos:"DEF",name:"Krepin Diatta",club:"Monaco"},
    {num:3,pos:"DEF",name:"Ismail Jakobs",club:"Monaco"},
    {num:4,pos:"DEF",name:"Kalidou Koulibaly",club:"Al Hilal"},
    {num:5,pos:"DEF",name:"Moussa Niakhate",club:"Nottingham Forest"},
    {num:6,pos:"DEF",name:"Abdoulaye Seck",club:"Al Ittihad Kalba"},
    {num:13,pos:"DEF",name:"Mamadou Sarr",club:"Chelsea"},
    {num:14,pos:"DEF",name:"El Hadj Malick Diouf",club:"Bologna"},
    {num:8,pos:"MID",name:"Idrissa Gueye",club:"Everton"},
    {num:10,pos:"MID",name:"Pape Matar Sarr",club:"Tottenham"},
    {num:17,pos:"MID",name:"Pape Gueye",club:"Marseille"},
    {num:18,pos:"MID",name:"Lamine Camara",club:"Monaco"},
    {num:19,pos:"MID",name:"Habib Diarra",club:"Strasbourg"},
    {num:20,pos:"MID",name:"Pathé Ciss",club:"Rayo Vallecano"},
    {num:7,pos:"FWD",name:"Sadio Mané",club:"Al Nassr"},
    {num:9,pos:"FWD",name:"Nicolas Jackson",club:"Chelsea"},
    {num:11,pos:"FWD",name:"Ismaila Sarr",club:"Crystal Palace"},
    {num:15,pos:"FWD",name:"Iliman Ndiaye",club:"Marseille"},
    {num:21,pos:"FWD",name:"Bamba Dieng",club:"Nice"},
    {num:22,pos:"FWD",name:"Assane Diao",club:"Burnley"},
  ]},
  // ── GROUP J ──────────────────────────────────────────────────
  Algeria:{coach:"Vladimir Petković",players:[
    ...
    {num:15,pos:"FWD",name:"Sofiane Bendebka",club:"Al-Fateh"},
  ...
  Argentina:{coach:"Lionel Scaloni",players:[
    ...
    {num:12,pos:"GK",name:"Geronimo Rulli",club:"Marseille"},
    {num:23,pos:"GK",name:"Franco Armani",club:"River Plate"},
    {num:2,pos:"DEF",name:"Gonzalo Montiel",club:"Nottingham Forest"},
    {num:3,pos:"DEF",name:"Nicolas Tagliafico",club:"Lyon"},
    {num:4,pos:"DEF",name:"Germán Pezzella",club:"Real Betis"},
    ...
    {num:17,pos:"MID",name:"Rodrigo De Paul",club:"Atletico Madrid"},
    {num:18,pos:"MID",name:"Leandro Paredes",club:"Roma"},
    {num:19,pos:"MID",name:"Giovani Lo Celso",club:"Real Betis"},
    {num:20,pos:"MID",name:"Alexis Mac Allister",club:"Liverpool"},
    {num:7,pos:"FWD",name:"Alejandro Garnacho",club:"Man United"},
    {num:9,pos:"FWD",name:"Julian Alvarez",club:"Man City"},
    {num:11,pos:"FWD",name:"Lautaro Martínez",club:"Inter Milan"},
    {num:15,pos:"FWD",name:"Nicolas González",club:"Juventus"},
    {num:21,pos:"FWD",name:"Paulo Dybala",club:"Roma"},
    {num:22,pos:"FWD",name:"Franco Mastantuono",club:"River Plate"},
  ]},
  Austria:{coach:"Ralf Rangnick",players:[
    {num:1,pos:"GK",name:"Alexander Schlager",club:"Schalke 04"},
    {num:12,pos:"GK",name:"Patrick Pentz",club:"Real Betis"},
    {num:23,pos:"GK",name:"Florian Wiegele",club:"Austria Klagenfurt"},
    {num:2,pos:"DEF",name:"Stefan Posch",club:"Bologna"},
    {num:3,pos:"DEF",name:"Philipp Mwene",club:"Mainz"},
    {num:4,pos:"DEF",name:"David Alaba",club:"Real Madrid"},
    {num:5,pos:"DEF",name:"Kevin Danso",club:"Lens"},
    {num:6,pos:"DEF",name:"Philipp Lienhart",club:"Freiburg"},
    {num:13,pos:"DEF",name:"Marco Friedl",club:"Werder Bremen"},
    {num:14,pos:"DEF",name:"Alexander Prass",club:"Wolfsburg"},
    {num:8,pos:"MID",name:"Nicolas Seiwald",club:"RB Leipzig"},
    {num:10,pos:"MID",name:"Marcel Sabitzer",club:"Man United"},
    {num:17,pos:"MID",name:"Xaver Schlager",club:"RB Leipzig"},
    {num:18,pos:"MID",name:"Florian Grillitsch",club:"Hoffenheim"},
    ...
    {num:7,pos:"FWD",name:"Michael Gregoritsch",club:"Freiburg"},
    {num:11,pos:"FWD",name:"Sasa Kalajdzic",club:"Eintracht Frankfurt"},
    {num:15,pos:"FWD",name:"Patrick Wimmer",club:"Wolfsburg"},
    {num:22,pos:"FWD",name:"Carney Chukwuemeka",club:"Chelsea"},
  ]},
  Jordan:{coach:"Jamal Sellami",players:[
    {num:1,pos:"GK",name:"Yazeed Abulaila",club:"Al-Faisaly"},
    {num:12,pos:"GK",name:"Mohammad Abu Sbeih",club:"Al-Jazeera"},
    {num:23,pos:"GK",name:"Salameh Yousef",club:"Al-Wihdat"},
    {num:2,pos:"DEF",name:"Mohammad Haikal",club:"Al-Wihdat"},
    {num:3,pos:"DEF",name:"Baha Faisal",club:"Al-Jazeera"},
    {num:4,pos:"DEF",name:"Badr Nofal",club:"Al-Ahli"},
    {num:5,pos:"DEF",name:"Yazan Naimat",club:"Al-Ramtha"},
    {num:6,pos:"DEF",name:"Osama Rashdan",club:"Al-Wihdat"},
    {num:13,pos:"DEF",name:"Khaled Al-Hajri",club:"Al-Faisaly"},
    {num:8,pos:"MID",name:"Musa Al-Taamari",club:"Montpellier"},
    {num:10,pos:"MID",name:"Yazan Al-Arab",club:"Al-Wihdat"},
    {num:17,pos:"MID",name:"Mohammad Hamdan",club:"Al-Jazeera"},
    {num:18,pos:"MID",name:"Ahmad Qattoush",club:"Al-Wihdat"},
    {num:7,pos:"FWD",name:"Ahmad Habeish",club:"Al-Wihdat"},
    {num:9,pos:"FWD",name:"Moussa Al-Taamari",club:"Lorient"},
    {num:11,pos:"FWD",name:"Hesham Halaweh",club:"Al-Ahli"},
    {num:15,pos:"FWD",name:"Ibrahim Hmoud",club:"Al-Faisaly"},
    {num:16,pos:"FWD",name:"Ahmad Al-Saadi",club:"Al-Ramtha"},
  ]},
  // ── GROUP K ──────────────────────────────────────────────────
  Portugal:{coach:"Roberto Martínez",players:[
    ...
    {num:13,pos:"DEF",name:"Renato Veiga",club:"Chelsea"},
    {num:14,pos:"DEF",name:"Nelson Semedo",club:"Wolves"},
    {num:15,pos:"DEF",name:"Tomas Araujo",club:"Barcelona"},
    {num:8,pos:"MID",name:"Bruno Fernandes",club:"Man United"},
    {num:10,pos:"MID",name:"Bernardo Silva",club:"Man City"},
    {num:16,pos:"MID",name:"Joao Neves",club:"PSG"},
    {num:17,pos:"MID",name:"Vitinha",club:"PSG"},
    {num:18,pos:"MID",name:"Ruben Neves",club:"Al Hilal"},
    {num:19,pos:"MID",name:"Matheus Nunes",club:"Man City"},
    ...
    {num:20,pos:"FWD",name:"Joao Felix",club:"Chelsea"},
    {num:21,pos:"FWD",name:"Francisco Conceição",club:"Juventus"},
    {num:22,pos:"FWD",name:"Goncalo Ramos",club:"PSG"},
    {num:24,pos:"FWD",name:"Goncalo Guedes",club:"Wolves"},
  ]},
  Colombia:{coach:"Néstor Lorenzo",players:[
    {num:1,pos:"GK",name:"David Ospina",club:"Al-Qadsiah"},
    {num:12,pos:"GK",name:"Camilo Vargas",club:"Atlas"},
    {num:23,pos:"GK",name:"Alvaro Montero",club:"Millonarios"},
    {num:2,pos:"DEF",name:"Santiago Arias",club:"Atletico Mineiro"},
    {num:3,pos:"DEF",name:"Johan Mojica",club:"Villarreal"},
    {num:4,pos:"DEF",name:"Davinson Sanchez",club:"Galatasaray"},
    {num:5,pos:"DEF",name:"Yerry Mina",club:"Fiorentina"},
    {num:6,pos:"DEF",name:"Daniel Munoz",club:"Crystal Palace"},
    {num:13,pos:"DEF",name:"Jhon Lucumi",club:"Bologna"},
    {num:14,pos:"DEF",name:"Deiver Machado",club:"Lens"},
    {num:8,pos:"MID",name:"Jefferson Lerma",club:"Crystal Palace"},
    {num:10,pos:"MID",name:"James Rodríguez",club:"Rayo Vallecano"},
    {num:16,pos:"MID",name:"Richard Rios",club:"Benfica"},
    {num:17,pos:"MID",name:"Juan Fernando Quintero",club:"Junior"},
    {num:18,pos:"MID",name:"Luis Díaz",club:"Bayern Munich"},
    {num:19,pos:"MID",name:"Jhon Arias",club:"Fluminense"},
    {num:7,pos:"FWD",name:"Cucho Hernandez",club:"Columbus Crew"},
    {num:9,pos:"FWD",name:"Jhon Córdoba",club:"Krasnodar"},
    {num:11,pos:"FWD",name:"Duvan Zapata",club:"Torino"},
    {num:15,pos:"FWD",name:"Luis Suarez",club:"Cruz Azul"},
    {num:20,pos:"FWD",name:"Kevin Castano",club:"Aucas"},
    {num:21,pos:"FWD",name:"Jhon Durán",club:"Al Qadsiah"},
  ]},
  "DR Congo":{coach:"Sébastien Desabre",players:[
    {num:1,pos:"GK",name:"Lionel Mpasi",club:"TP Mazembe"},
    {num:12,pos:"GK",name:"Timothy Fayulu",club:"AS Vita Club"},
    {num:23,pos:"GK",name:"Matthieu Epolo",club:"Nottingham Forest"},
    {num:2,pos:"DEF",name:"Aaron Wan-Bissaka",club:"West Ham"},
    {num:3,pos:"DEF",name:"Arthur Masuaku",club:"Besiktas"},
    {num:4,pos:"DEF",name:"Chancel Mbemba",club:"Marseille"},
    {num:5,pos:"DEF",name:"Gedeon Kalulu",club:"Juventus"},
    {num:6,pos:"DEF",name:"Dylan Batubinsika",club:"Strasbourg"},
    {num:13,pos:"DEF",name:"Joris Kayembe",club:"Anderlecht"},
    {num:14,pos:"DEF",name:"Axel Tuanzebe",club:"Ipswich Town"},
    {num:15,pos:"DEF",name:"Rocky Bushiri",club:"Nottingham Forest"},
    {num:8,pos:"MID",name:"Samuel Moutoussamy",club:"Getafe"},
    {num:10,pos:"MID",name:"Gael Kakuta",club:"Al-Qadsiah"},
    {num:17,pos:"MID",name:"Meschak Elia",club:"Young Boys"},
    {num:18,pos:"MID",name:"Noah Sadiki",club:"Anderlecht"},
    {num:19,pos:"MID",name:"Edo Kayembe",club:"Watford"},
    {num:20,pos:"MID",name:"Charles Pickel",club:"Strasbourg"},
    {num:7,pos:"FWD",name:"Yoane Wissa",club:"Brentford"},
    {num:9,pos:"FWD",name:"Cedric Bakambu",club:"Celta Vigo"},
    {num:11,pos:"FWD",name:"Simon Banza",club:"Braga"},
    {num:15,pos:"FWD",name:"Fiston Mayele",club:"Pyramids FC"},
    {num:16,pos:"FWD",name:"Theo Bongonba",club:"SC Cambuur"},
  ]},
  Uzbekistan:{coach:"Fabio Cannavaro",players:[
    {num:1,pos:"GK",name:"Utkir Yusupov",club:"FC Metallurg"},
    {num:12,pos:"GK",name:"Oybek Sobirov",club:"FC Pakhtakor"},
    {num:23,pos:"GK",name:"Botir Tursunov",club:"FC Nasaf"},
    {num:2,pos:"DEF",name:"Jaloliddin Masharipov",club:"CSKA Moscow"},
    {num:3,pos:"DEF",name:"Abbosbek Fayzullaev",club:"Lokomotiv Moscow"},
    {num:4,pos:"DEF",name:"Eldor Shomurodov",club:"Roma"},
    {num:5,pos:"DEF",name:"Otabek Shukurov",club:"FC Pakhtakor"},
    {num:6,pos:"DEF",name:"Khurshid Kasymov",club:"FC Bunyodkor"},
    {num:13,pos:"DEF",name:"Dostonbek Tursunov",club:"FC Navbahor"},
    {num:8,pos:"MID",name:"Bobur Abdullayev",club:"FC Pakhtakor"},
    {num:10,pos:"MID",name:"Odil Ahmedov",club:"FC Krasnodar"},
    {num:17,pos:"MID",name:"Nodir Tursunov",club:"FC Bunyodkor"},
    {num:18,pos:"MID",name:"Jamshid Iskanderov",club:"FC Pakhtakor"},
    {num:19,pos:"MID",name:"Jahongir Sidikov",club:"FC Metallurg"},
    {num:7,pos:"FWD",name:"Sherzod Nazarov",club:"Lokomotiv Moscow"},
    {num:9,pos:"FWD",name:"Aleksei Shchetinin",club:"FC Pakhtakor"},
    {num:11,pos:"FWD",name:"Husan Nasimov",club:"FC Bunyodkor"},
    {num:15,pos:"FWD",name:"Sanjar Tursunov",club:"FC Metallurg"},
  ]},
  // ── GROUP L ──────────────────────────────────────────────────
  England:{coach:"Thomas Tuchel",players:[
    ...
    {num:14,pos:"DEF",name:"Djed Spence",club:"Genoa"},
    {num:15,pos:"DEF",name:"Jarrell Quansah",club:"Liverpool"},
    {num:16,pos:"DEF",name:"Nico O'Reilly",club:"Man City"},
    {num:8,pos:"MID",name:"Jude Bellingham",club:"Real Madrid"},
    {num:10,pos:"MID",name:"Declan Rice",club:"Arsenal"},
    {num:17,pos:"MID",name:"Jordan Henderson",club:"Ajax"},
    {num:18,pos:"MID",name:"Kobbie Mainoo",club:"Man United"},
    {num:19,pos:"MID",name:"Morgan Rogers",club:"Aston Villa"},
    {num:20,pos:"MID",name:"Eberechi Eze",club:"Crystal Palace"},
    {num:21,pos:"MID",name:"Elliot Anderson",club:"Nottingham Forest"},
  ...
  Croatia:{coach:"Zlatko Dalić",players:[
    ...
    {num:12,pos:"GK",name:"Dominik Kotarski",club:"Lokomotiv Moscow"},
    {num:23,pos:"GK",name:"Ivor Pandur",club:"Lecce"},
    {num:2,pos:"DEF",name:"Josip Stanišić",club:"Bayer Leverkusen"},
    ...
    {num:14,pos:"DEF",name:"Luka Vušković",club:"Tottenham"},
    ...
    {num:19,pos:"MID",name:"Luka Sučić",club:"RB Salzburg"},
    {num:20,pos:"MID",name:"Martin Baturina",club:"Chelsea"},
    {num:21,pos:"MID",name:"Kristijan Jakić",club:"Eintracht Frankfurt"},
    ...
    {num:15,pos:"FWD",name:"Petar Musa",club:"FC Dallas"},
    {num:16,pos:"FWD",name:"Igor Matanović",club:"Eintracht Frankfurt"},
    {num:22,pos:"FWD",name:"Marco Pašalić",club:"Augsburg"},
  ]},
  Ghana:{coach:"Carlos Queiroz",players:[
    ...
    {num:19,pos:"MID",name:"Daniel Kofi Kyereh",club:"Freiburg"},
  ...
  Panama:{coach:"Thomas Christiansen",players:[
    ...
    {num:14,pos:"DEF",name:"Jorge Gutierrez",club:"Mazatlan"},
    ...
    {num:19,pos:"MID",name:"Alberto Quintero",club:"San Jose Earthquakes"},
    ...
    {num:21,pos:"FWD",name:"Adolfo Machado",club:"New England Revolution"},
  ]},
};
